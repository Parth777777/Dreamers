...
class Noise {
  ...
  constructor(seed = 0) {
    ...
    this.p = [
      ...
      172, 9, 129, 22, 39, 253, 19, 98, 108, 110, 79, 113, 224, 232, 178, 185, 112, 104, 218, 246, 97, 228, 251, 34,
...
export default function Waves({
  ...
  useEffect(() => {
    ...
    const tick = (time: number) => {
      ...
      lines.forEach((points) => {
        const start = moved(points[0], false);
        ctx.moveTo(start.x, start.y);
        points.forEach((p, idx) => {
          const isLast = idx === points.length - 1;
          const p1 = moved(p, !isLast);
  ...
  }, [lineColor, waveAmpX, waveAmpY, waveSpeedX, waveSpeedY, xGap, yGap]);

  return (
    <div ref={containerRef} className="waves" style={{ backgroundColor }}>
